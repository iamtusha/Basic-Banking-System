...
<head>
    ...
    left: 0;
    z-index: 20;
    background: #78a8ad center no-repeat;
    text-align:center;
        }
...
<body style="background-color:#78a8ad;">
...
<div id="container">
    ...
    <div class="container-large"
        style="color:white; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:#78a8ad;">
        <div class="row">
            ...
            <div class="col" style="margin:4% 0% 0% 5%; text-align:center;">
                &nbsp;<img src="statics/finance.png" alt="" height=300px width=800px >
            </div>
        </div>
    </div>
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:white;"><b> Facilities</b></h1>
                ...
                <div class="row">
                    <div class="col-lg">
                        <div
                            ...
                            <a href="all_cust.php"><button type="button" class="btn btn-outline-light mybtn">
